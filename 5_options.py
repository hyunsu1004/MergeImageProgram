from tkinter import *
import tkinter.ttk as ttk #__all__
from tkinter import filedialog #서브 모듈이기 떄문에 별도로 import
...
def add_file():
    ...
    #최초의 사용자가 지정한 경로를 보여줌 r " "
        initialdir=r"C:\Users\gustn\OneDrive\바탕 화면\파이썬 공부\gui_basic") #최초에 C:/ 경로를 보여줌
...
def browse_dest_path():
    ...
    txt_dest_path.delete(0,END) #Entry 위젯이기 때문에
...
txt_dest_path = Entry(path_frame) #만약 txt 위젯이였다면 "1.0" , END
...
btn_close = Button(frame_run,text="닫기",padx=5,pady=5,width=12,command=quit)
